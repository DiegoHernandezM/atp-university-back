...
import { useMaterialTailwindController, setOpenConfigurator, setOpenSidenav } from "@/context/MaterialTailwindContext";

export function DashboardNavbar() {
  const [controller, dispatch] = useMaterialTailwindController();
  const { fixedNavbar, openSidenav } = controller;
  const { url } = usePage(); // Hook de Inertia para obtener la URL actual
  const [layout, page] = url.split("/").filter((el) => el !== "");
...
DashboardNavbar.displayName = "/src/Components/Layouts/DashboardNavbar.jsx";
