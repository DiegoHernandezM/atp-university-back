        ...
        <nav className={`bg-white shadow-md ${fixed ? 'fixed' : ''} w-full z-10`}>
            ...
            {isOpen && (
                <div className="md:hidden px-4 pb-4">
                    <a href="#video" className="block text-gray-700 hover:text-blue-500 mb-2">Inicio</a>
                    <a href="#statistics" className="block text-gray-700 hover:text-blue-500 mb-2">Estadísticas</a>
                    <a href="#mission-vision" className="block text-gray-700 hover:text-blue-500 mb-2">Nosotros</a>
                    <a href="#services" className="block text-gray-700 hover:text-blue-500 mb-2">Servicios</a>
                    <a href="#gallery" className="block text-gray-700 hover:text-blue-500 mb-2">Simuladores</a>
                    <a href="#testimonials" className="block text-gray-700 hover:text-blue-500 mb-2">Testimonios</a>
                    <a href="#contact" className="block text-gray-700 hover:text-blue-500">Contacto</a>
                </div>
            )}
        </nav>
    );
