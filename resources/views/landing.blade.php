...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ mix('images/favicon.png') }}" type="image/png">

    <title>Shine - TailwindCSS Startup and SaaS Landing Page Template</title>

    <!-- Icon -->
    <link rel="stylesheet" type="text/css" href="{{ mix('css/LineIcons.2.0.css') }}">
    <!-- Animate -->
    <link rel="stylesheet" type="text/css" href="{{ mix('css/animate.css') }}">
    <!-- Tiny Slider  -->
    <link rel="stylesheet" type="text/css" href="{{ mix('css/tiny-slider.css') }}">
    <!-- Tailwind css -->
...
<body>
            ...
            <div class="flex justify-between">
                <div class="w-full text-center">
                    ...
                    <div class="text-center wow fadeInUp" data-wow-delay="1.6s">
                        <img class="img-fluid mx-auto" src="{{ mix('images/hero.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="mx-3 lg:mr-0 lg:ml-3 wow fadeInRight" data-wow-delay="0.3s">
                        <img src="{{ mix('images/feature/img-1.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="max-w-sm sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="team-item">
                        <div class="team-img relative">
                            <img class="img-fluid" src="{{ mix('images/team/img1.jpg') }}" alt="">
                ...
                <div class="max-w-sm sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="team-item">
                        <div class="team-img relative">
                            <img class="img-fluid" src="{{ mix('images/team/img2.jpg') }}" alt="">
                            <div class="team-overlay">
                                <ul class="flex justify-center">
                                    <li class="mx-1">
                                        <a href="#" class="social-link hover:bg-indigo-500">
                ...
                <div class="max-w-sm sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="team-item">
                        <div class="team-img relative">
                            <img class="img-fluid" src="{{ mix('images/team/img3.jpg') }}" alt="">
                            <div class="team-overlay">
                                <ul class="flex justify-center">
                                    <li class="mx-1">
                                        <a href="#" class="social-link hover:bg-indigo-500">
            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-1/2 md:w-1/4 lg:w-1/4">
                    <div class="m-3 wow fadeInUp" data-wow-delay="0.3s">
                        <img class="client-logo" src="{{ mix('images/clients/img1.svg') }}" alt="">
                    </div>
                </div>
                <div class="w-1/2 md:w-1/4 lg:w-1/4">
                    <div class="m-3 wow fadeInUp" data-wow-delay="0.6s">
                        <img class="client-logo" src="{{ mix('images/clients/img2.svg') }}" alt="">
                    </div>
                </div>
                <div class="w-1/2 md:w-1/4 lg:w-1/4">
                    <div class="m-3 wow fadeInUp" data-wow-delay="0.9s">
                        <img class="client-logo" src="{{ mix('images/clients/img3.svg') }}" alt="">
                    </div>
                </div>
                <div class="w-1/2 md:w-1/4 lg:w-1/4">
                    <div class="m-3 wow fadeInUp" data-wow-delay="1.2s">
                        <img class="client-logo" src="{{ mix('images/clients/img4.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div id="testimonials" class="testimonials">
                            ...
                            <div class="text-center py-10 px-8 md:px-10 rounded border border-gray-900">
                                ...
                                <div class="my-3 mx-auto w-24 h-24 shadow-md rounded-full">
                                    <img class="rounded-full p-2 w-full"
                                        src="{{ mix('images/testimonial/img1.jpg') }}" alt="">
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="item focus:outline-none">
                            <div class="text-center py-10 px-8 md:px-10 rounded border border-gray-900">
                                ...
                                <div class="my-3 mx-auto w-24 h-24 shadow-md rounded-full">
                                    <img class="rounded-full p-2 w-full"
                                        src="{{ mix('images/testimonial/img2.jpg') }}" alt="">
                                </div>
                                <div class="mb-2">
            ...
            <div class="flex">
                <div class="w-full relative">
                    <div class="portfolio-carousel">
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img1.jpg') }}" alt="">
                        </div>
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img2.jpg') }}" alt="">
                        </div>
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img3.jpg') }}" alt="">
                        </div>
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img4.jpg') }}" alt="">
                        </div>
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img5.jpg') }}" alt="">
                        </div>
                        <div>
                            <img class="w-full" src="{{ mix('images/slide/img6.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-3 mb-8">
                        <div class="footer-logo mb-3">
                            <img src="{{ mix('images/logo.svg') }}" alt="">
                        </div>
    ...
    <script src="{{ mix('js/tiny-slider.js') }}"></script>
